...
// ─── Course feature: view + data-source states ───────────────────────────────

/// Drives the UI of the Courses screen. Kept separate from [AuthState] so the
/// two features can evolve independently.
enum CourseStatus { initial, loading, success, error, empty }

/// Where the currently-displayed course list came from. Lets the UI show an
/// "offline / cached" banner when data was served from local storage.
